...
```bash
go install github.com/brownhounds/openapi-tsgen@v0.1.0
```

### Install Script LINUX/amd64

```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/brownhounds/openapi-tsgen/v0.1.0/tools/install-linux-amd64.sh)"
```

### Install Script LINUX/arm64

```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/brownhounds/openapi-tsgen/v0.1.0/tools/install-linux-arm64.sh)"
```
