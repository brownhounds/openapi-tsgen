...
```bash
go install github.com/brownhounds/openapi-tsgen@v0.1.3
```

### Install Script LINUX/amd64

```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/brownhounds/openapi-tsgen/v0.1.3/tools/install-linux-amd64.sh)"
```

### Install Script LINUX/arm64

```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/brownhounds/openapi-tsgen/v0.1.3/tools/install-linux-arm64.sh)"
```
