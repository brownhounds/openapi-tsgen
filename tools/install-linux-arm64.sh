...
wget https://github.com/brownhounds/openapi-tsgen/releases/download/v0.1.3/openapi-tsgen-linux-arm64
...
mv ./openapi-tsgen-linux-arm64 $HOME/.local/bin/openapi-tsgen
